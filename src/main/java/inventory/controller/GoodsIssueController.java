...
import inventory.validate.InvoiceIssueValidator;
...
public class GoodsIssueController {
    ...
    InvoiceIssueValidator invoiceIssueValidator;
    ...
    private void initBinder (WebDataBinder binder) {
        ...
        binder.addValidators(invoiceIssueValidator);
    }
    ...
    public String showInvoiceList(Model model, @ModelAttribute("searchForm") Invoice invoice,
        ...
        model.addAttribute("view", "/invoice/goodsIssue/goodsIssue-list");
    ...
    public String add(Model model) {
        ...
        model.addAttribute("view", "/invoice/goodsIssue/goodsIssue-action");
